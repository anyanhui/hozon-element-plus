...
Hozon Element Plus components are using English **by default**, if you wish you use other
...
Hozon Element Plus also provides a Vue component [ConfigProvider](/en-US/component/config-provider)
